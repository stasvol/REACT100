...
const state: any = {
  users: [
    {
      id: 1,
      photoUrl: 'https://download-cs.net/steam/avatars/3424.jpg',
      followed: true,
      fullName: 'Anna',
      status: 'I am a boss',
    ...
    {
      id: 2,
      photoUrl: 'https://cs16planet.ru/steam-avatars/images/avatar2960.jpg',
      followed: false,
      fullName: 'Ivan',
      status: 'I am a boss',
    ...
    },
    {
      ...
      fullName: 'Sweta ',
      status: 'I am a boss',
      location: { country: 'Ukraine', city: 'Rivne' },
    },
  ],
